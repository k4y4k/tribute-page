...
;(function (t) {
  ...
  var h = (function (t) {
    ...
    D.rectangleIntersectsSegment = function (t, e, a, r, i, n, s, o, l, h, f) {
      if (l === void 0) {
        l = null
      }
      if (h === void 0) {
  ...
  var a = (function (t) {
    ...
    l.ellipseIntersectsSegment = function (t, e, a, r, i, n, s, o, l, h, f) {
      if (l === void 0) {
        l = null
      }
      if (h === void 0) {
  ...
  var t = (function (e) {
    ...
    y.prototype.advanceTime = function (t) {
      ...
      if (this._actions.length > 0) {
        for (var f = 0, u = this._actions; f < u.length; f++) {
          var _ = u[f]
          var m = _.actionData
          if (m !== null) {
            if (m.type === 0) {
        ...
        if (e.inheritScale && (!_ || m !== null)) {
          if (_) {
            ...
            if (!e.inheritRotation) {
              ...
              if (l && h) {
                u = a.rotation - (o.global.rotation + Math.PI)
              } else if (l) {
                u = a.rotation + o.global.rotation + Math.PI
              } else if (h) {
                u = a.rotation + o.global.rotation
              } else {
                u = a.rotation - o.global.rotation
              }
              a.rotation = u
          ...
          if (e.inheritRotation) {
            ...
            if (l && h) {
              u = a.rotation + Math.PI
            } else {
              if (l) {
                u = Math.PI - a.rotation
              } else {
                u = -a.rotation
              }
              a.skew += Math.PI
...
;(function (t) {
  var e = (function (l) {
    ...
    P.prototype._getAffineTransform = function (
      ...
      var c = l - i
      var d = h - n
      f.rotation = Math.atan2(p, m)
      f.skew = Math.atan2(d, c) - Math.PI * 0.5 - f.rotation
      if (_) {
        f.rotation += Math.PI
      }
      f.scaleX = Math.sqrt(m * m + p * p) / a
      f.scaleY = Math.sqrt(c * c + d * d) / r
      f.toMatrix(u)
      ...
      if (this._parent !== null) {
        if (this._parent._boneData.type === 1) {
          for (var l = 0, h = i; l < h; ++l) {
            ...
            var u = r[n + f] + o[f]
            var _ = r[n + f + 1] + o[f + 1]
            var m = this._parent._getGlobalTransformMatrix(u, _)
            s[f] = m.a * u + m.c * _ + m.tx
            s[f + 1] = m.b * u + m.d * _ + m.ty
          }
        } else {
          ...
          for (var l = 0, h = i; l < h; ++l) {
            ...
            var u = r[n + f] + o[f]
            var _ = r[n + f + 1] + o[f + 1]
            s[f] = p.a * u + p.c * _ + p.tx
            s[f + 1] = p.b * u + p.d * _ + p.ty
          }
        }
      } else {
        for (var l = 0, h = i; l < h; ++l) {
    ...
    P.prototype._getGlobalTransformMatrix = function (t, e) {
      ...
      var h = this._dX
      var f = this._dY
      var u = Math.floor((t + a) / h)
      var _ = Math.floor((e + a) / f)
      var m = 0
      var p = u * h - a
      var c = _ * f - a
      ...
      if (t < -a) {
        ...
        if (d[m] > 0) {
          ...
          var T = this._hullCache[8] + u * g
          var b = this._hullCache[9] + u * D
          var A = this._vertices
          if (i) {
            this._getAffineTransform(
              p + h,
        ...
        if (d[m] > 0) {
          ...
          var g = this._hullCache[10]
          var D = this._hullCache[11]
          var T = this._hullCache[6] - (s - u) * g
          var b = this._hullCache[7] - (s - u) * D
          var A = this._vertices
          if (i) {
            this._getAffineTransform(
              p + h,
        ...
        if (this._geometryData !== e) {
          ...
          if (this._geometryData !== null) {
            ...
            if (this._geometryData.weight !== null) {
              for (
                var u = 0, _ = this._geometryData.weight.bones.length;
                u < _;
                ++u
              ) {
                var m = this._armature.getBone(
                  this._geometryData.weight.bones[u].name
                )
...
;(function (U) {
  var t = (function (t) {
    ...
    e._helpMatrix = new U.Matrix()
    e._helpTransform = new U.Transform()
    e._helpPoint = new U.Point()
    return e
  })(U.BaseObject)
  U.Constraint = t
  var e = (function (t) {
    ...
    e.prototype._computeA = function () {
      ...
      e.rotation += U.Transform.normalizeRadian(r - e.rotation) * this._weight
      e.toMatrix(a)
    }
    e.prototype._computeB = function () {
      ...
      var E = U.Transform.normalizeRadian(g - d)
      r.rotation = c + E * this._weight
      r.toMatrix(e.globalTransformMatrix)
      var M = d + E * this._weight
      i.x = r.x + Math.cos(M) * m
      i.y = r.y + Math.sin(M) * m
      var I = Math.atan2(a.y - i.y, a.x - i.x)
      if (i.scaleX < 0) {
        I += Math.PI
      }
      i.rotation =
        ...
        p -
        c +
        U.Transform.normalizeRadian(I - E - p) * this._weight
      i.toMatrix(n)
    }
  ...
  var a = (function (e) {
    ...
    t.prototype._updatePathVertices = function (t) {
      ...
      if (h === null) {
        ...
        for (var _ = 0, m = l; _ < o; _ += 2) {
          var p = n[m++] * r
          var c = n[m++] * r
          var d = u.a * p + u.c * c + u.tx
          var y = u.b * p + u.d * c + u.ty
      ...
      for (var _ = 0, P = 0; _ < o; _++) {
        ...
        for (var B = 0, E = S; B < E; B++) {
          ...
          var u = I.globalTransformMatrix
          var F = n[b++]
          var p = n[b++] * r
          var c = n[b++] * r
          O += (u.a * p + u.c * c + u.tx) * F
          x += (u.b * p + u.d * c + u.ty) * F
        }
    ...
    t.prototype._computeBezierCurve = function (t, e, a, r, i) {
        ...
        for (var v = 0, g = 0, D = 0; v < e; v++, g += 3) {
          ...
          if (D !== p) {
            ...
            if (f && D === m) {
              ...
              this._computeVertices(D * 6 + 2, 8, 0, u)
            }
          }
      ...
      var G = 0
      for (var v = 0, g = 0, D = 0, z = 0; v < e; v++, g += 3) {
        var T = h[v]
        c += T
        var H = c
        if (f) {
        ...
        this.addCurvePosition(H * 0.1, O, x, B, E, M, I, F, C, l, g, a)
      }
    }
    ...
    t.prototype.update = function () {
      ...
      for (var p = 0, E = 3; p < f; p++, E += 3) {
        ...
        if (l) {
          ...
          var C = (Math.sqrt(M * M + I * I) / F - 1) * x + 1
          v.a *= C
          v.b *= C
        }
        P = g
...
;(function (g) {
  var t = (function (e) {
        ...
        if (n._fadeState > 0 && n._subFadeState > 0) {
          ...
          if (this._animationDirty && o > 0) {
            ...
            for (var l = 0, h = this._armature.getBones(); l < h.length; l++) {
              var f = h[l]
              f._cachedFrameIndices = s.getBoneCachedFrameIndices(f.name)
            }
    ...
    t.prototype.playConfig = function (t) {
      ...
      for (var f = 0, u = this._armature.getSlots(); f < u.length; f++) {
        var _ = u[f]
  ...
  var t = (function (e) {
        ...
        for (var t = 0, e = this._armature._constraints; t < e.length; t++) {
          ...
          if (r !== null) {
            for (var i = 0, n = r; i < n.length; i++) {
              ...
              switch (s.type) {
                case 30: {
                  var o = G.BaseObject.borrowObject(G.IKConstraintTimelineState)
                  o.target = a
    ...
    t.prototype._updateBoneAndSlotTimelines = function () {
      {
        ...
        for (var o = 0, l = this._armature.getBones(); o < l.length; o++) {
          ...
          if (i in t) {
            ...
            var f = this._animationData.getBoneTimelines(i)
            var u = this._armature.animation.getBlendState(
              z.BONE_TRANSFORM,
              h.name,
              h
            )
            if (f !== null) {
              for (var _ = 0, m = f; _ < m.length; _++) {
                ...
                switch (p.type) {
                  case 10: {
                    var r = G.BaseObject.borrowObject(G.BoneAllTimelineState)
                    r.target = u
                  ...
                  case 11: {
                    var r = G.BaseObject.borrowObject(
                      G.BoneTranslateTimelineState
                    )
                    r.target = u
                    r.init(this._armature, this, p)
                    this._boneTimelines.push(r)
                  ...
                  case 12: {
                    var r = G.BaseObject.borrowObject(G.BoneRotateTimelineState)
                    r.target = u
                    r.init(this._armature, this, p)
                    this._boneTimelines.push(r)
                    break
                  ...
                  case 13: {
                    var r = G.BaseObject.borrowObject(G.BoneScaleTimelineState)
                    r.target = u
                    r.init(this._armature, this, p)
                    this._boneTimelines.push(r)
                    break
                  ...
                  case 60: {
                    var r = G.BaseObject.borrowObject(G.AlphaTimelineState)
                  ...
                  case 50: {
                    var r = G.BaseObject.borrowObject(G.SurfaceTimelineState)
                    r.target = this._armature.animation.getBlendState(
                      z.SURFACE,
                      h.name,
                      h
      ...
      }
      {
        ...
        for (var S = 0, O = this._armature.getSlots(); S < O.length; S++) {
          ...
          if (i in g) {
            ...
            var M = false
            D.length = 0
            var f = this._animationData.getSlotTimelines(i)
            if (f !== null) {
              for (var I = 0, F = f; I < F.length; I++) {
                var p = F[I]
                switch (p.type) {
                  case 20: {
                    var r = G.BaseObject.borrowObject(
                      G.SlotDisplayTimelineState
                    )
                    r.target = x
                    r.init(this._armature, this, p)
                  ...
                  case 23: {
                    var r = G.BaseObject.borrowObject(G.SlotZIndexTimelineState)
                    r.target = this._armature.animation.getBlendState(
                      z.SLOT_Z_INDEX,
                      x.name,
                      x
                  ...
                  case 21: {
                    var r = G.BaseObject.borrowObject(G.SlotColorTimelineState)
                    r.target = x
                    r.init(this._armature, this, p)
                    this._slotTimelines.push(r)
                    M = true
                  ...
                  case 22: {
                    var C = this._animationData.parent.parent
                    var w = C.timelineArray
                    var N = this._animationData.frameIntOffset + w[p.offset + 3]
                    var R = C.frameIntArray
                    var k = R[N + 0]
                    if (k < 0) {
                      k += 65536
                    }
                    for (var j = 0, L = x.displayFrameCount; j < L; ++j) {
                      var V = x.getDisplayFrameAt(j)
                      var Y = V.getGeometryData()
                      if (Y === null) {
                        continue
                      }
                      if (Y.offset === k) {
                        var r = G.BaseObject.borrowObject(G.DeformTimelineState)
                        r.target = this._armature.animation.getBlendState(
                          z.SLOT_DEFORM,
                          V.rawDisplayData.name,
                          x
                        )
                        r.displayFrame = V
                        r.init(this._armature, this, p)
                        this._slotBlendTimelines.push(r)
                        V.updateDeformVertices()
                        D.push(k)
                        break
                      }
                    }
            ...
            if (this.resetToPose) {
              if (!E) {
                var r = G.BaseObject.borrowObject(G.SlotDisplayTimelineState)
                r.target = x
                r.init(this._armature, this, null)
                this._slotTimelines.push(r)
                this._poseTimelines.push(r)
              ...
              for (var j = 0, L = x.displayFrameCount; j < L; ++j) {
                var V = x.getDisplayFrameAt(j)
                if (V.deformVertices.length === 0) {
                  continue
                }
                var Y = V.getGeometryData()
                if (Y !== null && D.indexOf(Y.offset) < 0) {
                  var r = G.BaseObject.borrowObject(G.DeformTimelineState)
                  r.displayFrame = V
                  r.target = this._armature.animation.getBlendState(
                    z.SLOT_DEFORM,
        ...
        for (var c in g) {
          for (var U = 0, X = g[c]; U < X.length; U++) {
            var r = X[U]
    ...
    t.prototype._advanceFadeTime = function (t) {
      ...
      if (this._subFadeState < 0) {
        ...
        if (a) {
          var r = e ? G.EventObject.FADE_OUT : G.EventObject.FADE_IN
          if (this._armature.eventDispatcher.hasDBEventListener(r)) {
            var i = G.BaseObject.borrowObject(G.EventObject)
            i.type = r
      ...
      if (this._subFadeState > 0) {
        ...
        if (a) {
          var r = e
            ? G.EventObject.FADE_OUT_COMPLETE
            : G.EventObject.FADE_IN_COMPLETE
          if (this._armature.eventDispatcher.hasDBEventListener(r)) {
            var i = G.BaseObject.borrowObject(G.EventObject)
            i.type = r
            i.armature = this._armature
    ...
    t.prototype.init = function (t, e, a) {
      ...
      this._actionTimeline = G.BaseObject.borrowObject(G.ActionTimelineState)
      ...
      if (this._animationData.zOrderTimeline !== null) {
        this._zOrderTimeline = G.BaseObject.borrowObject(G.ZOrderTimelineState)
    ...
    t.prototype.advanceTime = function (t, e) {
      ...
      if (i) {
        ...
        var f = null
        if (n) {
          for (var u = 0, _ = this._boneTimelines.length; u < _; ++u) {
            var m = this._boneTimelines[u]
            if (m.playState <= 0) {
              m.update(s)
            }
            if (m.target !== f) {
        ...
        for (var u = 0, _ = this._boneBlendTimelines.length; u < _; ++u) {
          var m = this._boneBlendTimelines[u]
          if (m.playState <= 0) {
            m.update(s)
          }
        ...
        if (this.displayControl) {
          for (var u = 0, _ = this._slotTimelines.length; u < _; ++u) {
            var m = this._slotTimelines[u]
            if (m.playState <= 0) {
              var d = m.target
        ...
        for (var u = 0, _ = this._slotBlendTimelines.length; u < _; ++u) {
          var m = this._slotBlendTimelines[u]
          if (m.playState <= 0) {
            var p = m.target
            m.update(s)
            if (p.update(this)) {
        ...
        for (var u = 0, _ = this._constraintTimelines.length; u < _; ++u) {
          var m = this._constraintTimelines[u]
          if (m.playState <= 0) {
            m.update(s)
          }
        }
        if (this._animationTimelines.length > 0) {
          ...
          var D = null
          var T = null
          for (var u = 0, _ = this._animationTimelines.length; u < _; ++u) {
            var m = this._animationTimelines[u]
            if (m.playState <= 0) {
              m.update(s)
            }
            if (this.blendType === 1) {
    ...
    t.prototype.fadeOut = function (t, e) {
      ...
      if (this._fadeState > 0) {
        ...
        for (var h = 0, f = this._slotBlendTimelines; h < f.length; h++) {
          var i = f[h]
          i.fadeOut()
        }
        for (var u = 0, _ = this._constraintTimelines; u < _.length; u++) {
          var i = _[u]
          i.fadeOut()
        }
    ...
    t.prototype.addState = function (t, e) {
      ...
      if (e !== null) {
        for (var a = 0, r = e; a < r.length; a++) {
          ...
          switch (i.type) {
            case 40: {
              var n = G.BaseObject.borrowObject(
                G.AnimationProgressTimelineState
              )
              n.target = t
            ...
            case 41: {
              var n = G.BaseObject.borrowObject(G.AnimationWeightTimelineState)
              n.target = t
              n.init(this._armature, this, i)
              this._animationTimelines.push(n)
              break
            ...
            case 42: {
              var n = G.BaseObject.borrowObject(
                G.AnimationParametersTimelineState
              )
              n.target = t
              n.init(this._armature, this, i)
              this._animationTimelines.push(n)
        ...
        if (this._frameCount > 1) {
          ...
          if (this._frameIndex !== _) {
            ...
            if (this._timelineArray !== null) {
              this._frameOffset =
                this._animationData.frameOffset +
                this._timelineArray[f.offset + 5 + this._frameIndex]
              if (o) {
                if (m < 0) {
                  var p = Math.floor(r * this._frameRate)
                  m = this._frameIndices[f.frameIndicesOffset + p]
                ...
                while (m >= 0) {
                  var c =
                    this._animationData.frameOffset +
                    this._timelineArray[f.offset + 5 + m]
  ...
  var s = (function (s) {
    ...
    t.prototype.blend = function (t) {
      ...
      if (n !== null) {
        ...
        var h = this._rd
        for (var f = 0; f < this._deformCount; ++f) {
          var u = 0
          if (f < o) {
            u = n[l + f]
          } else if (f < o + s) {
  ...
  var t = (function (e) {
    ...
    $.prototype._samplingEasingCurve = function (t, e) {
      ...
      if (a % 3 === 1) {
        ...
        for (var i = 0, n = e.length; i < n; ++i) {
          ...
          while (y - d > 1e-4) {
            var v = (y + d) * 0.5
            this._getCurvePoint(l, h, f, u, _, m, p, c, v, this._helpPoint)
    ...
    $.prototype._mergeActionFrame = function (t, e, a, r, i) {
      ...
      for (var h = 0, f = s; h < f.length; h++) {
        var u = f[h]
        this._armature.addAction(u, false)
      }
    ...
    $.prototype._parseArmature = function (t, e) {
      ...
      if (tt.DataParser.BONE in t) {
        ...
        for (var o = 0, l = s; o < l.length; o++) {
          var h = l[o]
          var f = $._getString(h, tt.DataParser.PARENT, '')
          var u = this._parseBone(h)
          if (f.length > 0) {
            var _ = a.getBone(f)
            if (_ !== null) {
              u.parent = _
            } else {
              if (!(f in this._cacheBones)) {
                this._cacheBones[f] = []
              }
              this._cacheBones[f].push(u)
            }
          }
          if (u.name in this._cacheBones) {
            for (var m = 0, p = this._cacheBones[u.name]; m < p.length; m++) {
              var c = p[m]
              c.parent = u
            }
            delete this._cacheBones[u.name]
          }
          a.addBone(u)
          this._rawBones.push(u)
        }
      }
      ...
      if (tt.DataParser.PATH_CONSTRAINT in t) {
        var M = t[tt.DataParser.PATH_CONSTRAINT]
        for (var I = 0, F = M; I < F.length; I++) {
          var C = F[I]
          var D = this._parsePathConstraint(C)
          if (D) {
            a.addConstraint(D)
          }
        }
      }
      for (var w = 0, N = this._cacheRawMeshes.length; w < N; ++w) {
        var R = this._cacheRawMeshes[w]
      ...
      if (tt.DataParser.ANIMATION in t) {
        ...
        for (var U = 0, X = Y; U < X.length; U++) {
          var G = X[U]
          var z = this._parseAnimation(G)
          a.addAnimation(z)
        }
      }
      if (tt.DataParser.DEFAULT_ACTIONS in t) {
        var H = this._parseActionData(
          t[tt.DataParser.DEFAULT_ACTIONS],
          0,
          null,
          null
        )
        for (var W = 0, K = H; W < K.length; W++) {
          var Z = K[W]
          a.addAction(Z, true)
          if (Z.type === 0) {
            var z = a.getAnimation(Z.name)
            if (z !== null) {
              a.defaultAnimation = z
            }
          }
        }
      }
      if (tt.DataParser.ACTIONS in t) {
        var H = this._parseActionData(t[tt.DataParser.ACTIONS], 0, null, null)
        for (var q = 0, Q = H; q < Q.length; q++) {
          var Z = Q[q]
          a.addAction(Z, false)
        }
      }
          ...
          if (o !== null) {
            ...
            if (tt.DataParser.DISPLAY in n) {
              ...
              for (var h = 0, f = l; h < f.length; h++) {
                var u = f[h]
                if (u) {
                  e.addDisplay(s, this._parseDisplay(u))
                } else {
                  e.addDisplay(s, null)
                }
              }
      ...
      switch (r) {
        ...
        case 1: {
          ...
          if (tt.DataParser.ACTIONS in t) {
            ...
            var u = this._skin.getDisplays(this._slot.name)
            if (
              u === null
                ? this._slot.displayIndex === 0
                : this._slot.displayIndex === u.length
            ) {
              for (
    ...
    $.prototype._parseAnimation = function (t) {
      ...
      if (tt.DataParser.FFD in t) {
        ...
        for (var m = 0, p = o; m < p.length; m++) {
          ...
          var d = $._getString(f, tt.DataParser.SLOT, '')
          var y = $._getString(f, tt.DataParser.NAME, '')
          if (c.length === 0) {
      ...
      if (tt.DataParser.IK in t) {
        ...
        for (var g = 0, D = o; g < D.length; g++) {
          var f = D[g]
          var T = $._getString(f, tt.DataParser.NAME, '')
      ...
      if (tt.DataParser.TIMELINE in t) {
        ...
        for (var A = 0, P = o; A < P.length; A++) {
          var f = P[A]
          var S = $._getNumber(f, tt.DataParser.TYPE, 0)
          var O = $._getString(f, tt.DataParser.NAME, '')
          var v = null
          switch (S) {
            case 0:
              break
            ...
            case 41:
              ...
              if (S === 40 && e.blendType !== 0) {
                ...
                var x = v
                x.x = $._getNumber(f, tt.DataParser.X, 0)
                x.y = $._getNumber(f, tt.DataParser.Y, 0)
              }
            ...
            case 22: {
              ...
              for (var c in this._armature.skins) {
                ...
                for (var M in E.displays) {
                  var I = E.displays[M]
                  for (var F = 0, C = I; F < C.length; F++) {
                    var w = C[F]
                    if (w !== null && w.name === O) {
                      this._geometry = w.geometry
                      break
                    }
                  }
                }
    ...
    $.prototype._parseTimeline = function (t, e, a, r, i, n, s, o) {
      ...
      var f = this._frameFloatArray.length
      var u = this._timelineArray.length
      if (o === null) {
      ...
      if (t !== null) {
        this._timelineArray[u + 0] = Math.round(
          $._getNumber(t, tt.DataParser.SCALE, 1) * 100
        )
        this._timelineArray[u + 1] = Math.round(
          $._getNumber(t, tt.DataParser.OFFSET, 0) * 100
        )
      } else {
        this._timelineArray[u + 0] = 100
        this._timelineArray[u + 1] = 0
      }
      this._timelineArray[u + 2] = l
      this._timelineArray[u + 3] = n
      switch (this._frameValueType) {
        case 0:
          this._timelineArray[u + 4] = 0
          break
        case 1:
          this._timelineArray[u + 4] = h - this._animation.frameIntOffset
          break
        case 2:
          this._timelineArray[u + 4] = f - this._animation.frameFloatOffset
          break
      }
      if (l === 1) {
        o.frameIndicesOffset = -1
        this._timelineArray[u + 5 + 0] =
    ...
    $.prototype._parseSlotDeformFrame = function (t, e, a) {
      ...
      for (var c = 0; c < o * 2; c += 2) {
        ...
        if (h !== null) {
          ...
          this._helpMatrixA.transformPoint(f, u, this._helpPoint, true)
          f = this._helpPoint.x
          u = this._helpPoint.y
          for (var v = 0; v < y; ++v) {
            ...
            this._helpMatrixB.transformPoint(f, u, this._helpPoint, true)
            this._frameFloatArray[r + m++] = this._helpPoint.x
            this._frameFloatArray[r + m++] = this._helpPoint.y
          }
        } else {
          this._frameFloatArray[r + c] = f
          this._frameFloatArray[r + c + 1] = u
        }
      }
      if (e === 0) {
      ...
      if (typeof t === 'string') {
        ...
        for (var s = 0, o = t; s < o.length; s++) {
          ...
          if (tt.DataParser.SLOT in l) {
            var f = $._getString(l, tt.DataParser.SLOT, '')
            n.slot = this._armature.getSlot(f)
          } else {
            n.slot = r
          }
          var u = null
          if (tt.DataParser.INTS in l) {
            if (u === null) {
              u = tt.BaseObject.borrowObject(tt.UserData)
            }
    ...
    $.prototype._parseDeformFrame = function (t, e, a) {
      ...
      if (l !== null) {
        ...
        for (var u = 0; u < o * 2; u += 2) {
          ...
          this._frameFloatArray[r + u] = h
          this._frameFloatArray[r + u + 1] = f
        }
      }
      if (e === 0) {
    ...
    $.prototype._parseGeometry = function (t, e) {
      ...
      if (tt.DataParser.UVS in t) {
        var f = t[tt.DataParser.UVS]
        var u = s + r * 2
        this._floatArray.length += r * 2
        for (var o = 0, l = r * 2; o < l; ++o) {
          this._floatArray[u + o] = f[o]
        }
      }
      if (tt.DataParser.WEIGHTS in t) {
        ...
        if (tt.DataParser.BONE_POSE in t) {
          ...
          for (var o = 0, P = 0, S = p + 2 + d, O = c; o < r; ++o) {
            ...
            var M = this._floatArray[s + x + 1]
            this._helpMatrixA.transformPoint(E, M, this._helpPoint)
            E = this._helpPoint.x
            M = this._helpPoint.y
            for (var I = 0; I < B; ++I) {
              var b = _[P++]
              ...
              this._helpMatrixB.invert()
              this._helpMatrixB.transformPoint(E, M, this._helpPoint)
              this._intArray[S++] = F
          ...
          this._floatArray.length += m * 3
          for (var o = 0, P = 0, O = 0, S = p + 2 + d, w = c; o < m; o++) {
            var B = _[P++]
            this._intArray[S++] = B
            for (var I = 0; I < B; I++) {
              var F = _[P++]
              ...
              var E = a[O++]
              var M = a[O++]
              this._intArray[S++] = C.indexOf(F)
              this._floatArray[w++] = N
              this._floatArray[w++] = E
              this._floatArray[w++] = M
            }
          }
        }
        e.weight = v
    ...
    $.prototype._modifyArray = function () {
      ...
      var f = new Float32Array(l, t, this._floatArray.length)
      var u = new Int16Array(l, t + e, this._frameIntArray.length)
    ...
    $.prototype.parseTextureAtlasData = function (t, e, a) {
      ...
      if (tt.DataParser.SUB_TEXTURE in t) {
        ...
        for (var n = 0, s = i.length; n < s; ++n) {
          ...
          f.rotated = $._getBoolean(o, tt.DataParser.ROTATED, false)
          f.name = $._getString(o, tt.DataParser.NAME, '')
          f.region.x = $._getNumber(o, tt.DataParser.X, 0)
          f.region.y = $._getNumber(o, tt.DataParser.Y, 0)
          f.region.width = $._getNumber(o, tt.DataParser.WIDTH, 0)
          f.region.height = $._getNumber(o, tt.DataParser.HEIGHT, 0)
          if (l > 0 && h > 0) {
            f.frame = tt.TextureData.createRectangle()
            f.frame.x = $._getNumber(o, tt.DataParser.FRAME_X, 0)
            f.frame.y = $._getNumber(o, tt.DataParser.FRAME_Y, 0)
            f.frame.width = l
            f.frame.height = h
          }
          e.addTexture(f)
  ...
  var t = (function (o) {
    ...
    t.prototype._parseBinaryTimeline = function (t, e, a) {
      ...
      if (i === 1) {
        ...
        for (var l = 0, h = 0, f = 0, u = 0; l < s; ++l) {
          if (f + u <= l && h < i) {
            f = this._frameArrayBuffer[
              this._animation.frameOffset +
                this._timelineArrayBuffer[r.offset + 5 + h]
            ]
            if (h === i - 1) {
              u = this._animation.frameCount - f
            } else {
              u =
    ...
    t.prototype._parseAnimation = function (t) {
      ...
      if (g.DataParser.BONE in t) {
        ...
        for (var i in r) {
          ...
          for (var o = 0, l = n.length; o < l; o += 2) {
            var h = n[o]
            var f = n[o + 1]
            var u = this._parseBinaryTimeline(h, f)
            this._animation.addBoneTimeline(s.name, u)
          }
        }
      }
      if (g.DataParser.SLOT in t) {
        ...
        for (var i in r) {
          ...
          for (var o = 0, l = n.length; o < l; o += 2) {
            ...
            var f = n[o + 1]
            var u = this._parseBinaryTimeline(h, f)
            this._animation.addSlotTimeline(_.name, u)
          }
        }
      }
      if (g.DataParser.CONSTRAINT in t) {
        ...
        for (var i in r) {
          ...
          for (var o = 0, l = n.length; o < l; o += 2) {
            ...
            var f = n[o + 1]
            var u = this._parseBinaryTimeline(h, f)
            this._animation.addConstraintTimeline(m.name, u)
          }
        }
      }
      if (g.DataParser.TIMELINE in t) {
        ...
        for (var p = 0, c = n; p < c.length; p++) {
          var d = c[p]
          var f = g.ObjectDataParser._getNumber(d, g.DataParser.OFFSET, 0)
          if (f >= 0) {
            ...
            switch (h) {
              ...
              case 50:
              case 60:
                this._animation.addBoneTimeline(y, u)
                break
              case 20:
              case 21:
              case 22:
              case 23:
              case 24:
                this._animation.addSlotTimeline(y, u)
                break
              case 30:
                this._animation.addConstraintTimeline(y, u)
                break
              case 40:
              case 41:
              case 42:
                this._animation.addAnimationTimeline(y, u)
                break
            }
          }
        }
  ...
  var t = (function () {
    ...
    s.prototype._buildSlots = function (t, e) {
      ...
      for (var o = 0, l = t.armature.sortedSlots; o < l.length; o++) {
        var h = l[o]
        var f = h.name in i ? i[h.name] : null
        var u = this._buildSlot(t, h, e)
        if (f !== null) {
          u.displayFrameCount = f.length
          for (var _ = 0, m = u.displayFrameCount; _ < m; ++_) {
            var p = f[_]
            u.replaceRawDisplayData(p, _)
            if (p !== null) {
              if (t.textureAtlasName.length > 0) {
                var c = this._getTextureData(t.textureAtlasName, p.path)
                u.replaceTextureData(c, _)
              }
              var d = this._getSlotDisplay(t, p, u)
              u.replaceDisplay(d, _)
            } else {
              u.replaceDisplay(null)
            }
          }
        }
        u._setDisplayIndex(h.displayIndex, true)
      }
    }
    ...
    s.prototype.replaceSkin = function (t, e, a, r) {
      ...
      for (var s = 0, o = t.getSlots(); s < o.length; s++) {
        ...
        for (var f = 0, u = l.displayFrameCount; f < u; ++f) {
          var _ = h[f]
          l.replaceRawDisplayData(_, f)
          if (_ !== null) {
            l.replaceDisplay(this._getSlotDisplay(null, _, l), f)
          } else {
            l.replaceDisplay(null, f)
          }
        }
        i = true
      }
    ...
    s.prototype.replaceAnimation = function (t, e, a) {
      ...
      for (var o = 0, l = t.getSlots(); o < l.length; o++) {
        var h = l[o]
        var f = 0
        for (var u = 0, _ = h.displayList; u < _.length; u++) {
          var m = _[u]
          if (m instanceof y.Armature) {
            var p = r.getDisplays(h.name)
            if (p !== null && f < p.length) {
              var c = p[f]
              if (c !== null && c.type === 1) {
